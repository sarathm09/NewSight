...
def extractandsay():
    ...
    print "If you want guidelines, say yes. Else proceed to read news"
    speech.say("If you want guidelines, say yes. Else proceed to read news")
    opt = speech.input()
    if 'yes' in opt.lower():
        ...
        speech.say("Hera are some guidelines which will help you through NewSight")
        ...
        if "the hindu" in pap.lower():
            ...
            def deccan():
                ...
                numb = speech.input()
                print "Say yes if you want me to read the news. Else no"
                speech.say("Say yes if you want me to read t    he news. Else no")
                answ = speech.input()
                sps = True if 's' in answ.lower() else False
                if sps:
                    if 'news' in numb.lower():
